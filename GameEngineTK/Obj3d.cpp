...
//静的メンバ関数の実体
 Camera* Obj3d::m_pCamera;	//カメラのポインタ
 std::unique_ptr<DirectX::CommonStates> Obj3d::m_states;	//汎用ステート
 Microsoft::WRL::ComPtr<ID3D11Device>            Obj3d::m_d3dDevice;	//デバイス	
 Microsoft::WRL::ComPtr<ID3D11DeviceContext>     Obj3d::m_d3dContext;//コンテキスト
